...
export default function EditWorkers() {
    const {
      ...
      const fetchData = async () => {
        try {
          const id = params.id;
          const url = `${API_URL}/workers/single/${id}`;
    ...
    >
      ...
      <TextField
        placeholder={worker.contactEmail}
        margin="normal"
      ...
      />
      <TextField
        placeholder={worker.phoneNumber}
        margin="normal"
      ...
      <Button
        ...
        variant="contained"
        sx={{
          mt: 2, // Adjust the spacing as needed
          width: 250,
          backgroundColor: "#319aa0",
          borderRadius: "50px",
          color: "white",
